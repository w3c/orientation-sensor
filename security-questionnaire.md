...
Yes, but not directly. [Orientation sensor] specification requires user [permission] and implementation
...
Indirectly, orientation sensor readings can be used to [infer user input].
...
Not directly; However, orientation sensor data can be used to calculate direction or
orientation of the user in space. [Orientation sensor] requires [user permission][permission]
...
Yes. If user agent has [permission] to access concrete orientation sensor, the API provides means
to check if particular set of sensors are available within user’s local computing environment.
...
[security-and-privacy]: https://w3c.github.io/orientation-sensor/#security-and-privacy
[permission]: https://w3c.github.io/orientation-sensor/#model
